...
export function fetchUserStats() {
  return api.get('/admin/users/stats').then((r) => r.data);
}
...
export function banUser(id, reason) {
  return api.patch(`/admin/users/${id}/ban`, { reason: reason || null }).then((r) => r.data);
}

export function unbanUser(id) {
  return api.patch(`/admin/users/${id}/unban`).then((r) => r.data);
}
