    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-[slideUp_0.3s_ease-out]">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h4 className="font-extrabold text-[#012d1d] text-base">Confirm tour cancellation</h4>
          <button
            onClick={onClose}
        ...
        <form onSubmit={onSubmit}>
          <div className="px-6 py-5">
            <p className="bg-amber-50 border border-amber-200 text-amber-800 text-sm rounded-lg px-4 py-3 mb-4 leading-relaxed">
              ⚠️ <strong>Note:</strong> Tour cancellation may incur service fees or non-refundable charges depending on the cancellation terms and timing.
            </p>
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="reason" className="text-sm font-bold text-[#012d1d]">
                Reason for tour cancellation <span className="text-red-500">*</span>
              </label>
              <textarea
                id="reason"
                rows={4}
                placeholder="Please let us know why you want to cancel this trip..."
                value={cancelReason}
